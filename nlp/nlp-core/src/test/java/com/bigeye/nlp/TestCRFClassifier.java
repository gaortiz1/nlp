...
public class TestCRFClassifier {
    ...
    private static final String nerPath = "edu/stanford/nlp/models/ner/spanish.ancora.distsim.s512.crf.ser.gz";
  ...
  */
    ...
    /* --- Test caseless NER models --- */
        ...
        try {
            ...
            System.out.println(lowResults);
            System.out.println(highResults);
